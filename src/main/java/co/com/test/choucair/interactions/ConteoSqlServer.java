...
public class ConteoSqlServer implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo( WaitUntil.the(BTN_BUSCAR, isVisible()).forNoMoreThan(10).seconds() );
        ...
        actor.attemptsTo( WaitUntil.the(BTNQVF, isVisible()).forNoMoreThan(10).seconds() );
        actor.attemptsTo(Click.on(BTNQVF));
        actor.attemptsTo(NavegarTabs.getIN(2));
        actor.attemptsTo( WaitUntil.the(BTN_OPCIONES, isVisible()).forNoMoreThan(10).seconds() );
        actor.attemptsTo(Click.on(BTN_OPCIONES));
        actor.attemptsTo( WaitUntil.the(BTN_DATA_EDITOR, isVisible()).forNoMoreThan(10).seconds() );
        actor.attemptsTo(Click.on(BTN_DATA_EDITOR));
        actor.attemptsTo( WaitUntil.the(BTN_CARGAR_DATOS, isVisible()).forNoMoreThan(10).seconds() );
