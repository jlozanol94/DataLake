...
public class PageBuscarQVF extends PageObject {
    ...
    public static Target BTN_BUSCAR = Target.the("Buscar QVF").located(By.xpath("//*[@id=\"q-hub-toolbar\"]/div[1]/div[2]/div[2]/button/span"));
    ...
    public static Target BTNCLOSE= Target.the("Click en CERRAR").located(By.xpath("//*[@id=\"show-service-overlay\"]/div[2]/div/div/div[2]/footer/div/button"));
    ...
    public static Target BTN_OPCIONES = Target.the("Click OPCIONES").located(By.xpath("//*[@id=\"qv-page-container\"]/div[1]/div/div[1]/div[1]/div/button"));
    public static Target BTN_DATA_EDITOR = Target.the("Click EDITOR DE DATOS").located(By.xpath("//*[@id=\"rlui-popover-1\"]/div[1]/ul/div[1]/li[3]/div[2]"));
